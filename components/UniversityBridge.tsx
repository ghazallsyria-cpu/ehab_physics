  ...
  return (
    <div className="max-w-6xl mx-auto py-12 px-6 animate-fadeIn font-['Tajawal'] text-white">
      <div className="mb-12 border-r-4 border-[#fbbf24] pr-6">
        ...
        <p className="text-gray-400 text-xl">سد الفجوة اللغوية والرياضية لطلبة جامعة الكويت.</p>
      </div>

      <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
           <div className="glass-panel p-10 rounded-[50px] border-white/5">
              <h3 className="text-2xl font-black mb-6 text-[#00d2ff]">منهج وزارة التربية</h3>
              <ul className="space-y-4 text-gray-400 text-sm">
                 <li>• دراسة بالعربي (مصطلحات محلية).</li>
           ...
           <div className="glass-panel p-10 rounded-[50px] border-[#fbbf24]/20 bg-[#fbbf24]/5">
              <h3 className="text-2xl font-black mb-6 text-[#fbbf24]">منهج جامعة الكويت (101)</h3>
              <ul className="space-y-4 text-gray-400 text-sm">
