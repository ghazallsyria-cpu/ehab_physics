...
const Sidebar: React.FC<SidebarProps> = ({ currentView, setView, user, onLogout, isOpen, onClose }) => {
  ...
  return (
    <>
      ...
      <div className={`fixed inset-y-0 right-0 z-[60] w-72 bg-[#0f172a]/95 backdrop-blur-2xl border-l border-white/5 flex flex-col transition-transform duration-500 cubic-bezier(0.4, 0, 0.2, 1) shadow-[0_0_50px_rgba(0,0,0,0.5)] ${isOpen ? 'translate-x-0' : 'translate-x-full lg:translate-x-0'}`}>
          ...
          <div className="bg-white/[0.03] border border-white/5 p-4 rounded-3xl flex items-center gap-4 mb-6 relative overflow-hidden group">
             ...
             <div className="min-w-0 relative z-10">
                ...
                <div className="flex items-center gap-1.5 mt-1">
                   <div className={`w-2 h-2 rounded-full ${user.subscription === 'premium' ? 'bg-[#fbbf24]' : 'bg-gray-500'}`}></div>
