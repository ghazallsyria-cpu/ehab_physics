...
import { MOCK_STUDY_GROUPS } from '../constants';
    ...
    <div className="max-w-6xl mx-auto py-12 px-6 animate-fadeIn font-['Tajawal']">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        {MOCK_STUDY_GROUPS.map((group) => (
          <div key={group.id} className="glass-panel p-10 rounded-[50px] border-white/5 hover:border-[#00d2ff]/20 transition-all group">
             <div className="flex justify-between items-start mb-8">
                ...
                <div className="flex -space-x-4">
                   ...
                   <div className="w-10 h-10 rounded-full border-2 border-[#010304] bg-[#00d2ff] flex items-center justify-center text-[8px] font-black text-black">+{group.membersCount - 3}</div>
                </div>
             </div>
